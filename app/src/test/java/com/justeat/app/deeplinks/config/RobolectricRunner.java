package com.justeat.app.deeplinks.config;
...
public class RobolectricRunner extends RobolectricGradleTestRunner {
    ...
    public RobolectricRunner(Class<?> klass) throws InitializationError {
        super(klass);
    ...
    protected AndroidManifest getAppManifest(Config config) {
        ...
        appManifest.setPackageName("com.justeat.app.deeplinks");
